...
<div style="display: flex; gap: 25px; align-items: flex-start; flex-wrap: wrap;">
  ...
  <div style="flex: 1; min-width: 450px;">
    ...
    In addition to mechanistic research, I actively engage in data and methodological development, notably the diagnostic global evapotranspiration model <a href="https://developers.google.com/earth-engine/datasets/publisher/pml_evapotranspiration" target="_blank" style="text-decoration: none;">PML-V2</a>. My work also encompasses the development, parallelization, and evaluation of conceptual and physically based distributed hydrological models. Ultimately, I aim to advance process-based frameworks for monitoring water–carbon coupling and enhancing ecohydrological resilience worldwide.
