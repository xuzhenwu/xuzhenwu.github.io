...
<div style="display: flex; gap: 30px; align-items: flex-start; flex-wrap: wrap;">
  ...
  <div style="width: 280px; flex-shrink: 0;">
    <video autoplay loop muted playsinline style="width: 100%; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1);">
